...
vertexShader: [
	...
	"void main() {",
		...
		"vRefractBackward[8] = refractOut(vRefractBackward[7], normal);",
			...
			"vRefractBegin[0] = vRefractForward[2];",
			"vRefractBegin[1] = vRefractForward[3];",
			"vRefractBegin[2] = vRefractForward[4];",

			"vRefractEnd[0] = vRefractBackward[4];",
			"vRefractEnd[1] = vRefractBackward[5];",
			"vRefractEnd[2] = vRefractBackward[6];",
