...
vertexShader: [
	...
	"void main() {",
		...
		"vRefractBackward[8] = refractOut(vRefractBackward[7], normal);",
			...
			"vRefractBegin[0] = vRefractForward[4];",
			"vRefractBegin[1] = vRefractForward[5];",
			"vRefractBegin[2] = vRefractForward[6];",

			"vRefractEnd[0] = vRefractBackward[2];",
			"vRefractEnd[1] = vRefractBackward[3];",
			"vRefractEnd[2] = vRefractBackward[4];",
