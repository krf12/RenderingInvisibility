...
THREE.InvisibilityInnerShader = {
	...
	vertexShader: [
		...
		"void main() {",
			...
			"vRefractBackward[0] = refractFull( normalize( vRefractForward[9] ), normal, 0.1 );",
			"vRefractBackward[1] = refractFull( normalize( vRefractBackward[0] ), normal, 0.2 );",
			"vRefractBackward[2] = refractFull( normalize( vRefractBackward[1] ), normal, 0.3 );",
			"vRefractBackward[3] = refractFull( normalize( vRefractBackward[2] ), normal, 0.4 );",
			"vRefractBackward[4] = refractFull( normalize( vRefractBackward[3] ), normal, 0.5 );",
			"vRefractBackward[5] = refractFull( normalize( vRefractBackward[4] ), normal, 0.6 );",
			"vRefractBackward[6] = refractFull( normalize( vRefractBackward[5] ), normal, 0.7);",
			"vRefractBackward[7] = refractFull( normalize( vRefractBackward[6] ), normal, 0.8);",
			"vRefractBackward[8] = refractFull( normalize( vRefractBackward[7] ), normal, 0.9);",
			"vRefractBackward[9] = refractFull( normalize( vRefractBackward[8] ), normal, 1.0);",

			"vRefractBegin[0] = vRefractForward[7];",
			"vRefractBegin[1] = vRefractForward[8];",
			"vRefractBegin[2] = vRefractForward[9];",

			"vRefractEnd[0] = vRefractBackward[0];",
			"vRefractEnd[1] = vRefractBackward[1];",
			"vRefractEnd[2] = vRefractBackward[2];",
