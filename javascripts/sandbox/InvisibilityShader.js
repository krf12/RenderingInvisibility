...
THREE.InvisibilityShader = {
	...
	vertexShader: [
		...
		"void main() {",
			...
			"vRefractBegin[0] = I;",
			"vRefractBegin[1] = vRefractForward[0];",
			"vRefractBegin[2] = vRefractForward[1];",

			"vRefractEnd[0] = vRefractBack[6];",
			"vRefractEnd[1] = vRefractBack[7];",
			"vRefractEnd[2] = vRefractBack[8];",
